...
let convertData =
      ...
      , run = Some "mkdir -p site/data && dhall-to-json --file synths.dhall > site/data/synths.json && dhall-to-json --file shipping.dhall > site/data/shipping.json"
      }
...
let generateCheckouts =
      ...
      , run = Some
          "cd PaymentLinks && uv sync && uv run main.py ../site/data"
      , env = Some
